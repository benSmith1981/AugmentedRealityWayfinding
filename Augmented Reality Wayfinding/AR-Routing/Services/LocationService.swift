...
//            4.7636324280000508,
//            52.309355904000029
            let startCoordLng = 4.7636324280000508
            let startCoordLat = 52.309355904000029
            let schipholLocation = CLLocation.init(latitude: startCoordLat, longitude: startCoordLng)
            delegate?.trackingLocation(for: schipholLocation)
//            delegate?.trackingLocation(for: location)
            self.currentLocation = schipholLocation
        }
